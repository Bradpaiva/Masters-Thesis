...
#from ScalDatasetFolders import *
from tkinter import *
...
button1=Button(master, text="Generate Spectagram Frames", style='W.TButton', command=SpecDatasetGen)
button1.grid(row=6, column=0,sticky="nsew")

button1=Button(master, text="Generate Scalogram Frames", style='W.TButton', command=display)
...
button1.grid(row=15, column=0,sticky="nsew")
